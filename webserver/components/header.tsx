...
const Header: FC<Record<string, never>> = function () {
  const { isOpenOnSmallScreens, setIsOpenOnSmallScreens } = useSidebarContext();
    ...
    <header className="sticky top-0 z-20">
      <Navbar fluid>
        <button
          ...
          onClick={() => setIsOpenOnSmallScreens(!isOpenOnSmallScreens)}
        >
        ...
        <Navbar.Brand href="/">
          <Image alt="IRL Server" height="24" src="/favicon.png" width="24" />
